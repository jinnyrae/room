...
<h1 class="pb-4 pt-5 mb-0 text-center">Mentions legales</h1>
<div class="container">
  <div class="row print text-center">
    <article>
      <p>
        ...
        SARL HOTELCOP Numéro de SIRET : 75221735600019<br>

        Responsable éditorial : HUGO Dupont<br>

        20 rue Tondu du Metz 60350 ATTICHY<br>

        Téléphone : 012345678<br>

        Fax : 0198765434<br>

        Email :room@room.com<br>

        Site Web : www.hotelcop.alaouf<br>

        Hébergement :<br>

        Hébergeur : SARL ANTHEDESIGN<br>
        20 rue Tondu Dubai 60350 ATTICHY<br>
        Site Web : www.ROOM.fr<br>

        Développement :<br>

        SARL ANTHEDESIGN<br>

        Adresse : 20 rue Tondu du Normandie 60350 France<br>

        Site Web : www.room.fr<br>

        Conditions d’utilisation :<br>

        Ce site (www.anthedesign.fr) est proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…) pour un meilleur confort d’utilisation et un graphisme plus agréable, nous vous recommandons de recourir à des navigateurs modernes comme Internet explorer, Safari, Firefox, Google Chrome, etc…<br>
        ...
        De manière générale, vous n’êtes pas tenu de nous communiquer vos données personnelles lorsque vous visitez notre site Internet www.anthedesign.fr.<br>
